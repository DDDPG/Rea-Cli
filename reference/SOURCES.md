...
- The API source is Cockos's
  ...
  inspected official pages do not state a page-level redistribution grant. API
  pitfalls and CLI notes are source-project summaries and historical observations;
  copied descriptions require confirmed Cockos terms or separate permission.
...
The three `.jsfx` files retain their imported bytes. The handbook documents
  ...
  DSP. No project MIT grant is applied to upstream descriptions; use them only
  under confirmed Cockos terms or separate permission.
