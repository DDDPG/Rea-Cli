...
`reference/` and `integrations/agents/` are delivered in Git, not in wheel or sdist. Runtime indexes/templates remain packaged. The skill requires this checkout and an installed reacli; it is not a zero-dependency standalone runtime.
