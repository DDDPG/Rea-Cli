...
See [full boundaries](../knowledge/rpp/blob_denylist.md), [known gaps](../knowledge/rpp/gap_registry.md), [schema](../../src/rac/data/knowledge/rpp_schema.json) and [extraction report](../knowledge/rpp/extract_report.json). Defaults in saved fixtures are host/configuration observations. A clean parse does not establish media availability, routing correctness or valid plugin state.
