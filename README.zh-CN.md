...
详见[三个 harness 的快速接入](docs/harness/README.zh-CN.md)和
[一句指令 showcase 需求](integrations/agents/acceptance/showcase-brief.md)。
...
**当前状态：** 0.1.0 alpha。从 PyPI 安装得到已发布包；从源码 checkout 安装得到
当前仓库代码。checkout 可能新于最近一次 PyPI 上传。API 仍可能调整。
...
- [Agent skill](integrations/agents/reaper-agent-cli/SKILL.md) · [仓库 skill 用法](integrations/agents/README.md) · [中文使用说明](integrations/agents/reaper-agent-cli/GUIDE.zh-CN.md)
...
[第三方声明](THIRD_PARTY_NOTICES.md) 与[来源说明](reference/SOURCES.md)。
