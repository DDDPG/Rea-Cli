...
[中文](README.zh-CN.md) · [Acceptance evidence](acceptance.md) · [Shared APIs](../ecosystem/api.md)
...
See the [recorded attempts and acceptance boundaries](acceptance.md).
...
Harness versions and actual model/backend failures belong in the acceptance record;
local CLI presence alone is not a live-test pass.
