...
[`THIRD_PARTY_NOTICES.md`](https://github.com/DDDPG/Rea-Cli/blob/main/THIRD_PARTY_NOTICES.md)
is the full repository boundary; this file is the package-scoped excerpt.
