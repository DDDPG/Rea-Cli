...
See `../../THIRD_PARTY_NOTICES.md` and `../../reference/SOURCES.md` in the source
repository for the repository-wide provenance record. The current parser package
scope is cleared under the recorded source conditions; this notice still requires
source attribution and applicable license terms.
